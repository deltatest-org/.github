...
```
.github/
├── workflow-templates/         # GitHub Actions organization starter templates
│   ├── deltatest.yml           # DeltaTest workflow template
│   └── deltatest.properties.json # Metadata for template
